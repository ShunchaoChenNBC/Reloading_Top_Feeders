...
create or replace table `nbcu-ds-sandbox-a-001.Shunchao_Sandbox_Final.Top_feeders_Metadata` as 
...
union all
select *
from  `nbcu-ds-sandbox-a-001.Shunchao_Sandbox_Final.Top_feeders_Metadata` 
order by 1,6 desc
